...
class GUI(GUIBase):
    ...
    def train_step(self):
        ...
        for viewpoint_cam in viewpoint_cams:
            ...
            #     depth_pred = (depth_pred - depth_pred.min()) / (depth_pred.max() - depth_pred.min() + eps)
        ...
        if self.stage == 'fine':
            ...
            # h_, w_, _ = self.gaussians.get_opacity
            # opacloss = ((1.0 - h_)**2).mean() #+ ((w_)**2).mean()
        ...
        with torch.no_grad():
            ...
            if self.iteration < self.opt.densify_until_iter :
                ...
                if  self.stage == 'fine' and self.iteration > self.opt.densify_from_iter :
                ...
                # elif self.stage == 'fine' and self.iteration % 1000 == 0 and self.iteration < (self.opt.densify_from_iter +1):

...
class SceneInfo(NamedTuple):
    ...
    train_cameras: CondenseData
    test_cameras: CondenseData
...
def readCondenseSceneInfo(datadir, downsample):

    train_cam_infos = CondenseData(datadir, downsample=downsample, split='train')
    test_cam_infos = CondenseData(datadir, downsample=downsample, split='test')
    ...
    scene_info = SceneInfo(point_cloud=pcd,
                           train_cameras= train_cam_infos,
                           test_cameras= test_cam_infos,
                           nerf_normalization=train_cam_infos.nerfpp_data,
                           ply_path=ply_path,
                           )
    return scene_info
